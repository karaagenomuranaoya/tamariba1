...
export default function MessageList({ messages, onImageClick, onReplyClick }: Props) {
  ...
  return (
    <div className="flex-1 overflow-y-auto p-3 space-y-4 bg-slate-50 scroll-smooth">
